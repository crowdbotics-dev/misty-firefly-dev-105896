"""
Django settings for misty_firefly_dev_105896 project.
...
ROOT_URLCONF = 'misty_firefly_dev_105896.urls'
...
WSGI_APPLICATION = 'misty_firefly_dev_105896.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "misty_firefly_dev_105896 API",
    "DESCRIPTION": "API documentation for misty_firefly_dev_105896 App",
    "VERSION": "v1",
}
